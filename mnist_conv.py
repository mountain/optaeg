...
class MNIST_OptAEGV3(MNISTModel):
    def __init__(self):
        ...
        self.conv0 = Conv2d(n_convs=4, kernel_size=(5,5), padding=(2,2), base_activation=OptAEGV3)
        self.lnon0 = OptAEGV2()
        self.conv1 = Conv2d(n_convs=10, kernel_size=(5,5), padding=(2,2), base_activation=OptAEGV3)
        self.lnon1 = OptAEGV2()
        self.conv2 = Conv2d(n_convs=4, kernel_size=(5,5), padding=(2,2), base_activation=OptAEGV3)
        self.lnon2 = OptAEGV2()
        self.fc = nn.Linear(160 * 3 * 3, 10, bias=False)
